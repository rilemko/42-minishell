...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_prs_process_039.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mconreau <mconreau@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/09 22:55:19 by mconreau          #+#    #+#             */
/*   Updated: 2023/04/23 19:45:17 by mconreau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ft_precheck(lne, tkn);
	if (lne->ptr.in_quotes_simple == TRUE
...
static void	ft_tokenize(t_lne *lne)
{
	if (lne->ptr.in_quotes == FALSE)
	{
		...
		lne->ptr.in_quotes_double = TRUE;
		lne->seg.rdr.arg.in_quotes_double = TRUE;
	}
	else if (lne->ptr.in_quotes_double == TRUE)
	{
		...
		lne->ptr.in_quotes_double = FALSE;
		lne->seg.rdr.arg.in_quotes_double = FALSE;
	}
}
